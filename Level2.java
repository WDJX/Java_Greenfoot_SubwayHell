...
//         addObject(new Health(), 250, 550);
       ...
       addObject(new HarderTrain(),Greenfoot.getRandomNumber(600), 70);
       addObject(new HarderTrain(),Greenfoot.getRandomNumber(600), 150);
       addObject(new HarderTrain(),Greenfoot.getRandomNumber(600), 230);
       addObject(new HarderTrain(),Greenfoot.getRandomNumber(600), 310);
       addObject(new HarderTrain(),Greenfoot.getRandomNumber(600), 390);
       addObject(new HarderTrain(),Greenfoot.getRandomNumber(600), 470);
